  ...
  "inline-flex items-center justify-center rounded-full text-sm font-medium  transition-[box-shadow,color,background-color] hover:bg-background/40 focus-visible:outline-none focus-visible:ring-[1.5px] focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 data-[pressed]:bg-card data-[pressed]:text-card-foreground",
  {
    variants: {
      variant: {
        ...
        ghost:
          "bg-transparent text-muted-foreground data-[pressed]:bg-accent data-[pressed]:text-accent-foreground",
      },
      size: {
        default: "h-9 px-3",
        sm: "h-6 px-3",
